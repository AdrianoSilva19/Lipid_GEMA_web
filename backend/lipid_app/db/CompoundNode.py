...
class CompoundNode(OntologyNode):
    ...
    def extract_node_properties(self, node_properties, other_aliases):
        ...
        if BOIMMGProperties.ANNOTATED.value in node_properties:
            self.annotated = node_properties[BOIMMGProperties.ANNOTATED.value]
        ...
        self.aliases = AliasesTransformer.transform_boimmg_aliases_into_model_seed(
            aliases
        )
